...
foreach ($footer_ticker_items as $key => $footer_ticker_item) {
    ...
    if ($key == count($footer_ticker_items) - 1) {
        $footer_ticker_html .= '<div class="heading-container"><a href="' . $link . '"><h2>' . esc_html($footer_ticker_item_headline) . '</h2></a><a href="' . $link . '" class="circle-buttonV2 circle-buttonV2--responsive circle-buttonV2--arrow-right"></a></div>';
    } else {
